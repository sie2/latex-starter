...
With this abbreviation you need not specify that columns are centered.
\begin{center}
  $\displaystyle
  \begin{pmatrix}
    a  &b \\
...
omitting the asterisk, as with \lstinline[style=inline]!align!
in place of \lstinline[style=inline]!align*!.
...
\vspace*{0ex}
Jim Hef{}feron, Saint Michael's College, VT USA\hfill 2017-Jan-19
}}
\end{document}
